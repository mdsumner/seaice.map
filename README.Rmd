...
```{r sentinel, eval=FALSE, include=FALSE}
...
sf::gdal_utils("buildvrt", f, tf1 <- tempfile(fileext = ".vrt"), options = "-separate")
sf::gdal_utils("translate", tf1, tf2 <- tempfile(fileext = ".vrt"), options = c("-outsize", "10%", "10%", "-scale", "-ot", "Byte"))
